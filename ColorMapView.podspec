Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/yoiang/ColorMapView"
  s.screenshots  = "https://github.com/yoiang/ColorMapView/blob/master/Screenshots/screenshot1.png?raw=true"
  s.license      = "MIT"
  s.author             = { "Ian G" => "yo.ian.g@gmail.com" }
  s.social_media_url   = "http://twitter.com/yoiang"
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/yoiang/ColorMapView.git", :tag => "1.0.0" }
